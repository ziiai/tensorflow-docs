...
* [Visualization](/docs/tensorflow/guide/summaries_and_tensorboard)
...
See [Reading Data](/docs/tensorflow/api_guides/python/reading_data#reading-from-files) to
...
Please see the [Images](/docs/tensorflow/api_guides/python/image) page for the list of
available distortions. We also attach an
`tf.summary.image` to the images
so that we may visualize them in [TensorBoard](/docs/tensorflow/guide/summaries_and_tensorboard).
...
`local3` | [fully connected layer with rectified linear activation](/docs/tensorflow/api_guides/python/nn).
`local4` | [fully connected layer with rectified linear activation](/docs/tensorflow/api_guides/python/nn).
...
algorithm (see [Training](/docs/tensorflow/api_guides/python/train) for other methods)
...
[checkpoint files](/docs/tensorflow/guide/saved_model)
...
[TensorBoard](/docs/tensorflow/guide/summaries_and_tensorboard) provides this
...
See how-to on [Sharing Variables](/docs/tensorflow/guide/variables).
